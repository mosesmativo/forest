...
import Community from "@/assets/comunity-fores.png";
import Urban from "@/assets/urban-restoration.png";
import Ecosystem from "@/assets/ecosystem-restoratioin.png";
   ...
   const programs = [
      {
         ...
         description:
            "We work with local communities to establish sustainable forests that provide both environmental and economic benefits.",
         image: Community,
      },
      {
         ...
         description:
            "Bringing trees back to cities improves air quality, reduces urban heat, and creates green spaces for everyone.",
         image: Urban,
      },
      {
         ...
         description:
            "We restore degraded lands and rebuild wildlife habitats through strategic tree planting and conservation efforts.",
         image: Ecosystem,
      },
   ];
         ...
         <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-16">
               ...
               <p
                  ...
                  Through our diverse range of initiatives, we're tackling
                  deforestation and environmental degradation from multiple
                  angles.
               </p>
            </div>
