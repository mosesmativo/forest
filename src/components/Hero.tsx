...
const Hero: React.FC = () => {
   ...
   return (
      <div className="relative h-screen w-full overflow-hidden">
         ...
         {/* Gradient Overlay */}
         <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/50 to-white/50"></div>
         ...
         <div className="relative container h-full flex flex-col justify-center items-start px-4 md:px-8 pt-16">
            ...
            text-sm font-medium text-leaf-600 transition-all duration-700 ${
            ...
            tracking-tight transition-all duration-700 delay-100 ${
               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}>
                  Let's make Earth
                  <br />
            ...
            transition-all duration-700 delay-200 ${
               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                  ...
                  Join our mission to restore forests worldwide and combat
                  climate change through community-driven tree planting
                  initiatives.
               </p>
